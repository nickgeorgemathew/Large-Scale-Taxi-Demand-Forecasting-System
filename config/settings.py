...
PROCESSED_PATH=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/data")#where the processed nyc data  by etl/spark pipeline is stored
FEATURES_PATH=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/data")#path to file that contains the name of selected features of the dataset used for prediciton and learning
LAG_HOURS=['lag_1h', 'lag_2h', 'lag_3h', 'lag_6h', 'lag_24h', 'lag_48h', 'lag_168h']#the list of hours when lag is choosen
...
MONITORED_FEATURES=['lag_1h', 'lag_2h', 'lag_3h', 'lag_6h', 'lag_24h', 'lag_48h', 'lag_168h','roll_mean_3h', 'roll_mean_6h', 'roll_mean_24h','roll_std_6h', 'mean', 'std']#features to be monitored to check if any drift or quality drop is happening
PUBLIC_HOLIDAYS_2022=""#rewrite as neccessary to the dataset ,to determine rush hours etc,a list of dates
RAW_DATA_PATH="C:/Users/nikhi/Downloads/yellow_tripdata_2022-03.parquet"#where the raw nyc taxi data is stored(path in str)
RAW_DATA_FORMAT="parquet"#which format the nyc taxi data raw is stored in
COLUMN_MAP = {
...
REQUIRED_COLUMNS=[ 'tpep_pickup_datetime', 'tpep_dropoff_datetime',
       'passenger_count', 'trip_distance','PULocationID', 'fare_amount', 'extra',
...
LOG=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/log")#file location for storing parquet logs
METRICLOG=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/log") #'model/artifacts/metric_history_24h.json','model/artifacts/metric_history_week.json'
PERFORMANCELOG=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/log")# LOG THE PERFORMANCE ISSUES LIKE FEATURE DRIFT,METRIC DEGRADATION ETC WITH TIMESTAMP IN THIS LOCATION 
MODEL_PATH=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/models/artifacts")#path of where the model is stored
QUANTILE_LOW_MODEL_PATH=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/models/artifacts")#path of where the model is stored
QUANTILE_HIGH_MODEL_PATH=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/models/artifacts")#path of where the model is stored
HOTSPOTS=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/log")#file path where to store the hotspots
RECENT_HISTORY=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/log")#file location for storing parquet logs
SERVING_HALTED=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/log")#location of json file containing flag of whether model is able to predict or not
MONITORING_CONFIG=Path("C:/Users/nikhi/Downloads/Large-Scale-Taxi-Demand-Forecasting-System/log")#file that serves as flag for """Switch monitoring to high‑frequency mode via config file."""
